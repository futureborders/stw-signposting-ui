...
let params:Params = {};
let exportParams:ExportsParams = {};
...
describe(`[GET] ${Route.search}`, () => {
  ...
  it('It should return status 302 and redirect to /manage-this-trade wih a valid commodityCode', async () => {
    const axiosSearchDataResponse: AxiosResponse = {
      ...mockedSearchDataCommodity,
      status: 200,
      statusText: 'OK',
  ...
  it(`It should return status 302 and redirect to ${Route.exportCheckYourAnswers} wih a valid commodityCode`, async () => {
    const axiosSearchDataResponse: AxiosResponse = {
      ...mockedSearchDataCommodity,
      status: 200,
      statusText: 'OK',
    ...
    await request(app.getServer())
      ...
      .expect(
        'Location',
        `${Route.exportCheckYourAnswers}${getParams(exportParams)}`,
      );
  });

  it(`It should return status 302 and redirect to ${Route.exportCheckYourAnswers} wih a valid declarable heading`, async () => {
    const axiosSearchDataResponse: AxiosResponse = {
      ...mockedSearchDataDeclarableHeading,
      status: 200,
      statusText: 'OK',
