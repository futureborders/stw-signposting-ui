...
describe(`[GET] ${Route.exportCheckInformationAndDocuments}`, () => {
  it('It should respond with statusCode 200', () => request(app.getServer())
    .get(`${Route.exportCheckInformationAndDocuments}`)
  ...
  it('It should return status 200 and show correct trade details', async () => {
    ...
    await request(app.getServer())
      .get(`${Route.exportCheckInformationAndDocuments}${getParams(params)}`)
      .set('user-agent', 'node-superagent')
      .expect(200)
      .then((res) => {
